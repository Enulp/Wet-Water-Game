...
public class MiniPower : MonoBehaviour 
{
	...
	void Pickup(Collider player)
	{
		...
		Camera.GetComponent<Camera>().GetComponent<CameraController>().offset.y += 3;
		Camera.GetComponent<Camera>().GetComponent<CameraController>().offset.z -= 4;
